                                ...
                                <table id="example1" class="table table-bordered table-hover">
                                    ...
                                    @foreach($allData as $key=>$value)
                                        <tr>
                                            ...
                                            <td>
                                                <a title="Edit" class="btn btn-sm btn-primary" href="{{route('product.edit',$value->id)}}"><i class="fa fa-edit"></i></a>
                                                <a title="Delete" target="_blank" class="btn btn-sm btn-success" href="{{route('product.delete',$value->id)}}"><i class="fa fa-minus-circle"></i></a>
