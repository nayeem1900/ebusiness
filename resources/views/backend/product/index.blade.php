                    ...
                    <section class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3>Product List
                                    <a class="btn btn-success btn-sm float-right" href="{{route('product.create')}}"><i class="fa fa-plus-circle"></i>Add Product</a>
                                </h3>
                                    ...
                                    @foreach($products as $key=>$product)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a title="Delete" target="_blank" class="btn btn-sm btn-success" href="{{route('product.delete',$product->id)}}"><i class="fa fa-minus-circle"></i></a>
