                            ...
                            <div class="card-body" >
                                ...
                                <form action="{{route('brand.update',$brand->id)}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" id="description" rows="8" cols="80" class="form-control" placeholder="write description" {!! $brand->description !!}></textarea>
                                    </div>



                                    <div class="form-group">
                                        <label for="old image">Brand Image Old Image</label><br>
                                        <img src="{!!asset('images/brands/' .$brand->image)!!}" width="50"><br>
                                        <label for="image">Brand Image New Image</label>
